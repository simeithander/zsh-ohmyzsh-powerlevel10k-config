![{002AF79D-9CF2-47F2-A892-D9E309290205}](https://github.com/user-attachments/assets/ae65d2c2-376c-4657-b904-4d67b981302d)
...
```bash
git clone https://github.com/simeithander/zsh-ohmyzsh-powerlevel10k-config.git
```

### 2. Acessando a pasta do repositório
- **Objetivo**: Navegar até a pasta do repositório clonado.

```bash
cd zsh-ohmyzsh-powerlevel10k-config
```

### 3. Dando permissões de execução ao script `.sh`
...
### 2. Accessing the repository folder
...
### 3. Giving execution permissions to the `.sh` script
